    ...
    <table width="720" height="55" border="1" cellspacing="1" id="example1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $row['education_duration']; ?></td>
                <td><?php echo $row['education_img']; ?></td>
                <td><a href="<?php echo $row['education_link']; ?>" target="_blank"><?php echo $row['education_link']; ?></a></td>
                <td><?php echo $row['education_desc']; ?></td>
                <td><?php echo $row['education_logo']; ?></td>
                <td>
                    <?php
                        echo ' <a href="education_view.php?ref='.$row["education_id"].'" data-id="'.$id.'">Details</a>';
                        echo ' <a href="education_update.php?ref='.$row["education_id"].'" data-id="'.$id.'">Edit</a>';
                        echo ' <a href="education_delete.php?ref='.$row["education_id"].'" data-id="'.$id.'" onclick="return confirm(\'Are you sure you want to delete this record?\')">Delete</a>';
                        }}
                    ?>
                </td>
            </tr>
